...
const AdminLocalizacion = lazy(() => import('./pages/admin/LocalizacionAdmin'));
      ...
      <Suspense fallback={null}>
        <Routes>
          ...
          >
            ...
            <Route path="localizacion" element={<RoleGuard requiredPermission="admin.localizacion.view"><AdminLocalizacion /></RoleGuard>} />
